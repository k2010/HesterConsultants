<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JobSearchAdmin.aspx.cs" Inherits="HesterConsultants.employees.JobSearchAdmin" %>
                    ...
                    <asp:ListView runat="server" 
                        ...
                        <LayoutTemplate>
                            <table class="openJobs">
                                <thead>
                                    ...
                                    <th style="width: 38%;">Instructions/Files</th><%-- use css ellipsis thing --%>
                        ...
                        <ItemTemplate>
                            <tr class='<%# Eval("JobStatus.Name").ToString().Replace(" ", "").Insert(0, "jobStatus") %>'>
                                ...
                                <td><asp:HyperLink runat="server" ID="hlJob" NavigateUrl='<%# Eval("JobId", "/clients/Job.aspx?jobId={0}") %>'>Inspect</asp:HyperLink></td>
                            </tr>
                        </ItemTemplate>
